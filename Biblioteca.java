...
public class Biblioteca {
        ...
        while (true) {
            ...
            switch (opcionSeleccion) {
                ...
                case 3:
                    ...
                    break;
                case 0:
                    return; // Salir del modo Selección
                default:
                    System.out.println("Opción no válida. Inténtelo de nuevo.");
            }
        }
    ...
    private int usuarioActualLibrosPrestados() {
        ...
        for (Producto producto : usuarioActual.productosSeleccionados) {
            // Aquí puedes agregar lógica específica para contar libros prestados
            contadorLibros++;
        }
        ...
        while (true) {
            ...
            switch (opcionPrestamo) {
                ...
                case 'f':
                    ...
                    break;
                case '0':
                    return; // Salir del modo Préstamo
                default:
                    System.out.println("Opción no válida. Inténtelo de nuevo.");
            }
        }
    ...
    private void imprimirListadoPrestamo() {
        // Implementar lógica para imprimir el listado de préstamo
    ...
    private void aplicarCupon() {
        ...
        if (respuesta.equalsIgnoreCase("Sí")) {
            // Implementa la lógica para aplicar el cupón (puedes incrementar la cantidad de días o realizar otras acciones)
    ...
    private void cambiarContrasena() {
        ...
        // Puedes implementar la lógica para verificar la fortaleza de la nueva contraseña antes de cambiarla
